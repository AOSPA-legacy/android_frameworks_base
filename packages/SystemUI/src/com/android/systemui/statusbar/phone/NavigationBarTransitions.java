...
public final class NavigationBarTransitions extends BarTransitions {
    ...
    private void setColorButtonNavigationBar(int ic_color) {
        setKeyButtonViewColor(mView.getHomeButton(), ic_color);
        setKeyButtonViewColor(mView.getRecentsButton(), ic_color);
        setKeyButtonViewColor(mView.getMenuButton(), ic_color);
